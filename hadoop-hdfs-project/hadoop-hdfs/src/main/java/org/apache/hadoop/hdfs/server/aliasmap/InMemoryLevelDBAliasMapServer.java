...
public class InMemoryLevelDBAliasMapServer implements InMemoryAliasMapProtocol,
  ...
  private InetSocketAddress getBindAddress(Configuration conf) {
  ...
  public static InetSocketAddress getServerAddress(Configuration conf) {
    ...
    if (nsId != null) {
      ...
      Map<String, InetSocketAddress> nsAddresses = getAddressesForNameserviceId(
          conf, nsId, DFS_PROVIDED_ALIASMAP_INMEMORY_RPC_ADDRESS_DEFAULT,
          DFS_PROVIDED_ALIASMAP_INMEMORY_RPC_ADDRESS);
